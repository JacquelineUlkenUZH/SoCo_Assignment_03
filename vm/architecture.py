...
OPS = {
    ...
    "inc": {"code": 0xC, "fmt": "r-"},  # Increment the value of a register
    "dec": {"code": 0xD, "fmt": "r-"},  # Decrement the value of a register
    "swp": {"code": 0xC, "fmt": "rr"},  # Swap the values of two registers
}
